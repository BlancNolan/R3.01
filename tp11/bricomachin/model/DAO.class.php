...
class DAO {
  // le singleton de la classe : l'unique objet  // static = attribut de class 
  ...
  private function __construct() { // prive car doit etre appeler une seul fois dans la methode get et non dans d'autre fichier
    try {
